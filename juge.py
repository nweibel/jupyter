...
def test_factorielle(factorielle):
...
def teste(factorielle, fibonacci):
    test_factorielle(factorielle)
    test_fibonacci(fibonacci)
    print("Bravo, les tests sont passés.\n")
    print("Votre mot de passe pour la suite est `1337`.")
